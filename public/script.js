...
// Expose auth functions via window._auth so the proxy functions in index.html can call them
// This works because script.js runs synchronously after Babel compiles it,
// and the proxy functions in <head> just delegate here.
window._auth = { loginUser, signupUser, loginAnonymous, logoutUser, showLogin, showSignup };
